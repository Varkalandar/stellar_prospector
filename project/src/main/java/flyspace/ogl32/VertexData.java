...
/**
 * Vertex data container. Position, normal, texture and color.
 * 
...
public class VertexData 
{
    ...
    private float[] normalXyzw = new float[] {0f, 1f, 0f, 0f};
    ...
    {
        this.normalXyzw = new float[] {x, y, z, 0};
    }
    ...
    public float[] getElements() {
        ...
        out[i++] = this.xyzw[2];
        out[i++] = this.xyzw[3];
        // Insert normal XYZW elements
        out[i++] = this.normalXyzw[0];
        out[i++] = this.normalXyzw[1];
        out[i++] = this.normalXyzw[2];
        out[i++] = this.normalXyzw[3];
