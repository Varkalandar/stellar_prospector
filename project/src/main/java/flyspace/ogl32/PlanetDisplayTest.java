 ...
 */
public class PlanetDisplayTest 
{
    // Entry point for the application
    public static void main(String[] args) 
    {
        new PlanetDisplayTest();
    }
