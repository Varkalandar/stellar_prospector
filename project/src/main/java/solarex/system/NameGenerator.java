...
public class NameGenerator {
    ...
    private static final String starSyllables [] =
    {
        "a",
        "e",
        "i",
    ...
    private static final String planetSyllables[] =
    {
        "a",
        "e",
        "i",
    ...
    private static final String personsFloat[] =
    {
        "Aweio",
        "Uiomya",
        "Eeiadma",
    ...
    private static final String personsRock[] =
    {
        "Zkrmths",
        "Krtbrgd",
        "Prtsngra",
    ...
    private static final String personsBreath[] =
    {
        "Altramer",
        "Shetan",
        "Soanow",
    ...
    private static String generateNameFromSyllables(final Random rng,
     ...
     * @return the generated name.
     */
    public static String generateStationName(final Random rng,
                                             final Society.Race race)
    {
        final StringBuffer buf = new StringBuffer();
