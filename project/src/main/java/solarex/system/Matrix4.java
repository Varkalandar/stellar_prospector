...
/**
 * Based on the Matrix4f class from LWGL 2
...
public class Matrix4 
{
     ...
     */
    public static Vec3 transform(Matrix4 left, Vec3 right, Vec3 dest) 
    {
        if (dest == null)
        {
            dest = new Vec3();
     ...
     */
    public static Matrix4 rotate(double angle, Vec3 axis, Matrix4 src, Matrix4 dest) 
    {
        if (dest == null)
        {
            dest = new Matrix4();
